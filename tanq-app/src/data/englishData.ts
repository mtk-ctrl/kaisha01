...
export const WORDS: WordEntry[] = [
  ...
  { emoji: '🧅', japanese: 'たまねぎ', english: 'onion', category: '食べ物', tip: '"アニオン"と読む。cutting onions makes you cry!（目が痛い）。spring onion=ねぎ🧅', sentence: 'My mother cooks with onion.', sentenceJP: '私のお母さんはたまねぎで料理します。' },
  ...
  { emoji: '🍑', japanese: 'もも', english: 'peach', category: '食べ物', tip: '"ピーチ"と読む。peachy=素晴らしい（俗語）。桃太郎の桃もpeach！peach color=ピーチ色🍑', sentence: 'This peach is very sweet.', sentenceJP: 'このももはとても甘いです。' },
  ...
  { emoji: '🍣', japanese: 'すし', english: 'sushi', category: '食べ物', tip: '"スシ"と読む。日本語がそのまま英語になった！sashimi=さしみも英語として使われる🍣', sentence: 'Sushi is a famous Japanese food.', sentenceJP: 'すしは有名な日本料理です。' },
  ...
  { emoji: '🐷', japanese: 'ぶた', english: 'pig', category: '動物', tip: '"ピッグ"と読む。piggy bank=ぶたのちょきん箱。"When pigs fly"=ありえない話！🐷', sentence: 'Pigs are very smart animals.', sentenceJP: 'ぶたはとても賢い動物です。' },
  ...
  { emoji: '🚀', japanese: 'そらをとぶ', english: 'fly', category: '動作', tip: '"フライ"と読む。fly a kite=凧を上げる。time flies=時間が経つのは早い。pilot=パイロット✈️', sentence: 'Birds can fly in the sky.', sentenceJP: 'とりは空を飛べます。' },
  ...
  { emoji: '🏃', japanese: 'いく・行く', english: 'go', category: '動作', tip: '"ゴー"と読む。go to school=学校に行く。let\'s go!=行こう！go + 動詞ingで「～しに行く」になる🏃', sentence: 'Let\'s go to the park today.', sentenceJP: '今日は公園に行きましょう。' },
  { emoji: '🏠', japanese: 'くる・来る', english: 'come', category: '動作', tip: '"カム"と読む。come back=帰ってくる。come on!=さあ！来て！come true=実現する🌟', sentence: 'Please come to school on time.', sentenceJP: '時間通りに学校に来てください。' },
  ...
  { emoji: '🐌', japanese: 'おそい', english: 'slow', category: '気持ち', tip: '"スロウ"と読む。slow motion=スローモーション。go slow=ゆっくり進む。fastの反対🐌', sentence: 'The turtle is very slow.', sentenceJP: 'カメはとてもおそいです。' },
  ...
  { emoji: '🍳', japanese: 'りょうりにん・シェフ', english: 'chef', category: '家族', tip: '"シェフ"と読む。フランス語から来た言葉。head chef=料理長。Top Chef=トップシェフ（料理番組）👨‍🍳', sentence: 'The chef cooked a wonderful meal.', sentenceJP: 'シェフは素晴らしい料理を作りました。' },
  ...
  { emoji: '🎳', japanese: 'ボウリング', english: 'bowling', category: 'スポーツ', tip: '"ボウリング"と読む。strike=全部倒す。spare=残りを全部倒す。bowling alley=ボウリング場🎳', sentence: 'Let\'s go bowling this weekend!', sentenceJP: '今週末ボウリングに行きましょう！' },
