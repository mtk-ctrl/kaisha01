  ...
  },
  {
    ...
    problems: [
      ...
      // ──────────────────────────────────
      {
        ...
        hints: [
          { step: 1, text: '全体を30とおいたよ。Aさんは10日で全部終わらせるんだね。' },
          { step: 2, text: '1日あたりの仕事量 ＝ 全体 ÷ かかる日数。30 ÷ 10 を計算しよう。' },
          { step: 3, text: '30 ÷ 10 ＝ 3。検算：3 × 10日 ＝ 30（全体）でぴったり ◎' },
        ],
        explanationText: 'Aの1日量 ＝ 全体30 ÷ 10日 ＝ 3。全体を最小公倍数にすると整数になる。',
      },
      {
        ...
        hints: [
          ...
          { step: 3, text: '30 ÷ 15 ＝ 2。検算：2 × 15日 ＝ 30 ◎' },
        ],
        explanationText: 'Bの1日量 ＝ 全体30 ÷ 15日 ＝ 2。',
      },
      {
        ...
        diagramType: 'none', diagramSpec: {},
        hints: [
          { step: 1, text: '2人で一緒にすると、1日にする量はそれぞれの量をたせばいいよ。' },
          { step: 2, text: 'A の 3 と B の 2 をたそう。' },
          { step: 3, text: '3 ＋ 2 ＝ 5。2人だと1日に5進む ◎' },
        ],
      ...
      },
      {
        ...
        diagramType: 'none', diagramSpec: {},
        hints: [
          { step: 1, text: 'まず全体を最小公倍数の30とおこう。A・Bの1日量を出すよ。' },
          { step: 2, text: 'A ＝ 30÷10 ＝ 3、B ＝ 30÷15 ＝ 2。2人で1日 3＋2＝5。日数 ＝ 全体 ÷ 1日量。' },
          { step: 3, text: '30 ÷ 5 ＝ 6日。検算：5 × 6日 ＝ 30（全体）◎' },
        ],
        explanationText: '全体30、2人で1日5 → 30 ÷ 5 ＝ 6日。',
      },
      // ──────────────────────────────────
      // ★★ いろいろな2人・1人ぶんを逆算
      // ──────────────────────────────────
      {
        ...
        diagramType: 'none', diagramSpec: {},
        hints: [
          { step: 1, text: '12と6の最小公倍数は12。全体を12とおこう。' },
          { step: 2, text: 'A ＝ 12÷12 ＝ 1、B ＝ 12÷6 ＝ 2。2人で1日 1＋2＝3。' },
          { step: 3, text: '12 ÷ 3 ＝ 4日。検算：3 × 4日 ＝ 12 ◎' },
        ],
        explanationText: '全体12、A＝1・B＝2、2人で1日3 → 12 ÷ 3 ＝ 4日。',
      },
      {
        ...
        diagramType: 'none', diagramSpec: {},
        hints: [
          { step: 1, text: '20と30の最小公倍数は60。全体を60とおこう。' },
          { step: 2, text: 'A ＝ 60÷20 ＝ 3、B ＝ 60÷30 ＝ 2。2人で1日 3＋2＝5。' },
          { step: 3, text: '60 ÷ 5 ＝ 12日。検算：5 × 12日 ＝ 60 ◎' },
        ],
        explanationText: '全体60、A＝3・B＝2、2人で1日5 → 60 ÷ 5 ＝ 12日。',
      },
      {
        ...
        hints: [
          ...
          { step: 3, text: 'B ＝ 3 － 1 ＝ 2。B1人だと 12 ÷ 2 ＝ 6日。検算：A1×4＋B2×4＝12 ◎' },
        ],
      ...
      },
      {
        ...
        hints: [
          ...
          { step: 3, text: '残り8をBだけ（1日1）でやると 8 ÷ 1 ＝ 8日間。検算：16 ＋ 1×8 ＝ 24（全体）◎' },
        ],
        explanationText: '全体24、A＝3・B＝1。2人4日で16、残り8をBが 8 ÷ 1 ＝ 8日間。',
      },
      {
        ...
        hints: [
          ...
          { step: 3, text: '残り6 ÷ 1 ＝ 6日。全部で 2 ＋ 6 ＝ 8日。検算：2人6＋A6＝12 ◎' },
        ],
      ...
      // ──────────────────────────────────
      {
        ...
        hints: [
          ...
          { step: 3, text: '30 ÷ 5 ＝ 6セット。1セット2日だから 6×2 ＝ 12日。検算：(3＋2)×6 ＝ 30 ◎' },
        ],
      ...
      },
      {
        ...
        hints: [
          ...
          { step: 3, text: 'Aがやった量 ＝ 24 － 12 ＝ 12。Aは1日1なので 12 ÷ 1 ＝ 12日間。検算：A1×12＋B3×4＝24 ◎' },
        ],
      ...
      },
      {
        ...
        hints: [
          ...
          { step: 3, text: '窓口3つは1分で3通す。x分で ○＋x△＝3x → 30＋0.5x＝3x → 30＝2.5x → x＝12分。検算：30＋0.5×12＝36、3×12＝36 ◎' },
        ],
        explanationText: 'もとの行列30・毎分0.5ふえる。3窓口は毎分3通す → 30＋0.5x＝3x → x＝12分。ふえ続ける仕事＝ニュートン算。',
      },
    ],
  },
  {
    ...
    problems: [
      ...
      // ──────────────────────────────────
      {
        ...
        hints: [
          ...
          { step: 3, text: '80 ＋ 20 ＝ 100m/分。検算：流れがある分、静水時より20速い ◎' },
        ],
        explanationText: '下り ＝ 静水時 ＋ 流れ ＝ 80 ＋ 20 ＝ 100m/分。',
      },
      {
        ...
        hints: [
          ...
          { step: 3, text: '90 － 30 ＝ 60m/分。検算：流れに逆らう分、静水時より30おそい ◎' },
        ],
        explanationText: '上り ＝ 静水時 － 流れ ＝ 90 － 30 ＝ 60m/分。',
      },
      {
        ...
        hints: [
          ...
          { step: 3, text: '3000 ÷ 80 ＝ 37.5分。検算：80 × 37.5 ＝ 3000m ◎' },
        ],
        explanationText: '下り ＝ 70 ＋ 10 ＝ 80。時間 ＝ 3000 ÷ 80 ＝ 37.5分。',
      },
      {
        ...
        hints: [
          ...
          { step: 3, text: '130 － 100 ＝ 30m/分。検算：100 ＋ 30 ＝ 130（下り）◎' },
        ],
        explanationText: '流れ ＝ 下り － 静水時 ＝ 130 － 100 ＝ 30m/分。',
      },
      // ──────────────────────────────────
      // ★ 上り・下りから静水・流れを和差算で
      // ──────────────────────────────────
      {
        ...
        hints: [
          ...
          { step: 3, text: '（120 ＋ 80）÷ 2 ＝ 100m/分。検算：静水100、流れ20 → 下り120・上り80 ◎' },
        ],
        explanationText: '静水時 ＝（下り ＋ 上り）÷ 2 ＝（120 ＋ 80）÷ 2 ＝ 100m/分。',
      },
      {
        ...
        hints: [
          ...
          { step: 3, text: '（120 － 80）÷ 2 ＝ 20m/分。検算：静水100、流れ20 → 下り120・上り80 ◎' },
        ],
        explanationText: '流れ ＝（下り − 上り）÷ 2 ＝（120 － 80）÷ 2 ＝ 20m/分。',
      },
      {
        ...
        hints: [
          ...
          { step: 3, text: '静水 ＝（120 ＋ 80）÷ 2 ＝ 100m/分。検算：流れ ＝（120−80）÷2＝20 ◎' },
        ],
        explanationText: '下り120・上り80を出してから、静水 ＝（120 ＋ 80）÷ 2 ＝ 100m/分。',
      },
      // ──────────────────────────────────
      // ★★ 往復・平均の速さ
      // ──────────────────────────────────
      {
        ...
        hints: [
          ...
          { step: 3, text: '下り 2400÷120＝20分、上り 2400÷80＝30分、合わせて50分。検算：往復の速さは平均してはダメ（時間でたす）◎' },
        ],
      ...
      },
      {
        ...
        hints: [
          ...
          { step: 3, text: '流れ ＝（120 － 80）÷ 2 ＝ 20m/分。検算：静水＝（120＋80）÷2＝100 ◎' },
        ],
        explanationText: '下り120・上り80 → 流れ ＝（120 － 80）÷ 2 ＝ 20m/分。',
      },
      // ──────────────────────────────────
      // ★★★ 流れが変わる・エンジンが止まる・2艘
      // ──────────────────────────────────
      {
        ...
        hints: [
          ...
          { step: 3, text: '前半 1200÷100＝12分、後半 1200÷120＝10分、合わせて22分。検算：100×12＋120×10＝2400m ◎' },
        ],
      ...
      },
      {
        ...
        hints: [
          ...
          { step: 3, text: '20 × 3 ＝ 60m 下流へ流される。検算：エンジンが動いていれば上っているが、止まると流れだけ＝20m/分 ◎' },
        ],
        explanationText: 'エンジンが止まると流れの速さ（20m/分）だけで流される。20 × 3 ＝ 60m。',
      },
      {
        ...
        hints: [
          ...
          { step: 3, text: '4500 ÷ 200 ＝ 22.5分。検算：120×22.5＝2700m、80×22.5＝1800m、合計4500m ◎' },
        ],
        explanationText: '流水算でも出会いは「速さの和」。4500 ÷（120 ＋ 80）＝ 22.5分。旅人算とつながる。',
      },
    ],
  },
]
