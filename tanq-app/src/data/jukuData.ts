  ...
  },
  {
    ...
    problems: [
      ...
      // ──────────────────────────────────
      {
        ...
        hints: [
          { step: 1, text: 'まず、できあがり（500g・5%）の中に食塩が何g入るか考えよう。' },
          { step: 2, text: '8% を □g とすると 3% は (500−□)g。食塩の合計で式：0.08×□ ＋ 0.03×(500−□) ＝ できあがりの食塩。' },
          { step: 3, text: 'できあがりの食塩は 25g。0.05×□ ＝ 10 → □ ＝ ?' },
        ],
      ...
      },
      {
        ...
        hints: [
          { step: 1, text: 'まず、できあがり（450g・16%）の食塩が何gか考えよう。' },
          { step: 2, text: '10% を □g とすると 20% は (450−□)g。0.10×□ ＋ 0.20×(450−□) ＝ できあがりの食塩。' },
          { step: 3, text: 'できあがりの食塩は 72g。0.10×□ ＝ 18 → □ ＝ 180g（10%）。20% は 450 − 180 ＝ ?' },
        ],
