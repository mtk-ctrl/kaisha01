...
const RIKA_SOON = ['ふりこ・滑車（計算）', '電気回路（計算）', '水溶液・中和（計算）', '浮力（計算）']
                ...
                <div className="space-y-2">
                  {units.map(unit => {
                    if (unit.status === 'full') {
                      ...
                      const fullDone = isBane ? baneCleared : tekoCleared
                      const fullTotal = isBane ? BANE_PROBLEMS.length : TEKO_PROBLEMS.length
                      return (
