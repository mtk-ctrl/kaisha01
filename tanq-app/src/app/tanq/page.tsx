...
const STEP_ORDER_IDS = ['hook', 'density_intro', 'dissolve_intro', 'intro', 'ice_question', 'dissolve_question', 'question', 'logic_intro', 'collection']
      ...
      <div className="flex flex-col items-center justify-center min-h-screen gap-5 px-6 text-center bg-tanquu-light max-w-sm mx-auto">
        ...
        <div className="flex gap-3 w-full max-w-sm pop-in">
          ...
          <button
            onClick={() => {
              onComplete()
              // remount by going home then re-selecting — simpler than resetting reducer
              onHome()
            }}
