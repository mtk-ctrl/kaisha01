...
> **理科は単元マップ方式（2026-06-12 構造転換のひな型）**: /juken 理科枠に21単元（生物6・地学5・物理5・化学5）を全表示。てこのつり合い＝「まなぶ＋とく」公開、他20単元＝知識演習のみ公開（`/apps/science?unit=単元id`）。網羅率は「まなぶ＋とく 1・知識演習 20」と内訳まで正直表示し、計算演習未着手（ばね・電気・水溶液・浮力）は近日公開枠に明示。
>
...
| `src/data/rikaUnits.ts` | 中学受験 理科 単元マップ（21単元・4分野＋既存問題の割当てロジック） |
