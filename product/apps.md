...
| 国語〈読解〉ためしてみる版 | /apps/dokkai | AI生成オリジナル文22問（3文よみとり10題＋だんらくよみとり6題×2問）・足場ヒント→根拠文ハイライト・感想3択（localStorage） | ❌ |
...
>
> 社会は 都道府県マスター（/apps/todofuken）＋ 歴史〈旧石器〜平安〉（/apps/rekishi）を /juken の社会枠から導線。歴史〈鎌倉〜現代〉・公民、国語の文法・敬語と読解ステップ3（短文）は「近日公開」枠で表示。国語読解ステップ1・2は /juken 国語枠から「ためしてみる版」として導線（Phase B 家族テスト用プロト）。歴史アプリ内のタイムラインで鎌倉以降の全体像を「近日公開」として提示。
