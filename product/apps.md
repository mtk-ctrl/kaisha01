...
> **理科は単元マップ方式（2026-06-12 構造転換のひな型）**: /juken 理科枠に22単元（生物6・地学5・物理6・化学5）を全表示。てこのつり合い・ばねののび・電気回路（豆電球と乾電池）＝「まなぶ＋とく」公開、他19単元＝知識演習のみ公開（`/apps/science?unit=単元id`）。網羅率は「まなぶ＋とく 3・知識演習 19」と内訳まで正直表示し、計算演習未着手（ふりこ・滑車・水溶液・浮力）は近日公開枠に明示。
>
