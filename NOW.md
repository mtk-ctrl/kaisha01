...
> **最終更新**: 2026-07-11（**読解ステップ4 3本目「補欠のバトン」公開＝初の★★★入試レベル**（物語1248字×6問・心情の変化/比喩「むねの奥の石」/複雑な心情「くやしいのにうれしい」）。長文は3本（★/★★/★★★）・読解計60問。オーナー判定→OKなら★★★を標準に量産へ） | 更新者: Jobs
...
1. **国語読解の本格化（優先1・進行中）** — ステップ4〈長文読解〉3本公開済み・文章えらび方式: s4-01「さいごのごめんね」★物語890字×4問／s4-02「里山」★★説明870字×4問／**s4-03「補欠のバトン」★★★物語1248字×6問（入試レベル1本目・2026-07-11）**。s4-03のオーナー判定待ち→**OKなら★★★（1200〜1600字・5〜6問）を標準に、次は説明文★★★を1本**。将来: 詩・随筆・記述＋AI採点。AI生成オリジナル文（転載禁止は既決）・紛らわしい選択肢3類型（問いに合わない/言い過ぎ/本文にない）・根拠文ハイライト・`paraBreaks` で段落。**細切れ原則＝1本仕上げ→画面確認→オーナー判定→次へ**。「ためしてみる版」表記は長文6本そろうまで維持（アキ判断）。記述＋AI採点はスコープ外（後続）
...
| 日付 | 内容 |
|------|------|
| 2026-07-11 | 読解ステップ4 3本目「補欠のバトン」公開（s4-03・初の★★★入試レベル＝物語1248字×6問・気持ち/比喩の言いかえ/理由/複雑な心情/変化の根拠/主題・嫉妬→応援→目標の心情変化と「むねの奥の石」の比喩・読解計60問・Playwright 4画面目視・build EXIT=0） |
