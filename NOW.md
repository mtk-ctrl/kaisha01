...
| 日付 | 内容 |
|------|------|
| 2026-06-17 | 理科の品質改善とカード整理（オーナー指摘）：①知識260問ヒントの答え漏れ14問修正＋単元演習をレベル順に②理科アプリを単元主役カード＋?domain ディープリンク③ラボの理科カードを4領域に分割④ラボ全カード背景を教科色で統一（国/算/理/社）⑤問題文クリアネス全数点検＝北半球・化学2・物理1を明確化 |
